...
public class HomePage {
	 ...
	 */
	@Test(groups = {"TC-36144","US-3414","BUG-742","NEW"}, enabled = true, priority = 43)
	public void testBackgroundColorForAgeGroups1() throws IOException, IllegalArgumentException, MalformedURLException {
	       try{
	    	   // INITIALISATION:
	           helper.printXmlPath(new RuntimeException().getStackTrace()[0]);
	           driver = helper.getServerName(driver);
	 ...
	 */
	@Test(groups = {"TC-36144","US-3414","BUG-742","NEW"}, enabled = true, priority = 43)
	public void testBackgroundColorForAgeGroups2() throws IOException, IllegalArgumentException, MalformedURLException {
	       try{
	    	   // INITIALISATION:
	           helper.printXmlPath(new RuntimeException().getStackTrace()[0]);
	           driver = helper.getServerName(driver);
