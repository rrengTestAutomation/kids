...
public class BrandPage {
	 ...
	 * @throws AWTException 
	 */
	@Test(groups = {"TC-35404","US-3522","US-3202","BUG-972","CLOSED"}, enabled = true, priority = 38)
...
//             (new Actions(driver)).dragAndDrop(driver.findElement(By.xpath(bottomXpath)), driver.findElement(By.xpath(topXpath))).perform(); 
	 ...
	 */
	@Test(groups = {"TC-36113","US-3996","US-4452","BUG-972","CLOSED"}, priority = 41)
	 ...
	 */
	@Test(groups = {"TC-36146","US-3496","BUG-972","CLOSED"}, priority = 44)
	 ...
	 */
	@Test(groups = {"TC-36414","US-4097","BUG-798","BUG-972","CLOSED"}, enabled = true, priority = 45)
	 ...
	 */
	@Test(groups = {"TC-36413","US-3550","US-4271","BUG-832","BUG-972","CLOSED"}, enabled = true, priority = 46)
	 ...
	 * <p>Test Cases: 36413 3550 4271 832 972</p>
	 */
	@Test(groups = {"TC-36413","US-3550","US-4271","BUG-832","BUG-972","CLOSED"}, enabled = true, priority = 47)
	 ...
	 */
	@Test(groups = {"TC-36413","US-3550","US-4271","BUG-854","BUG-972","CLOSED"}, enabled = true, priority = 48)
	 ...
	 * <p>Test Cases: 36413 3550 4271 854 972</p>
	 */
	@Test(groups = {"TC-36413","US-3550","US-4271","BUG-854","BUG-972","CLOSED"}, enabled = true, priority = 49)
	 ...
	 */
	@Test(groups = {"TC-35413","US-3309","TC-35459","US-3183","BUG-972","CLOSED"}, enabled = true, priority = 50)
	 ...
	 */
	@Test(groups = {"TC-35474","US-2079","BUG-972","CLOSED"}, priority = 52)
	 ...
	 * <p>Test Cases: 35474 2079 972</p>
	 */
	@Test(groups = {"TC-35474","US-2079","BUG-972","CLOSED"}, priority = 53)
	 ...
	 * <p>Test Cases: 35474 2079 972</p>
	 */
	@Test(groups = {"TC-35474","US-2079","BUG-972","CLOSED"}, priority = 54)
	 ...
	 * <p>Test Cases: 35474 2079 972</p>
	 */
	@Test(groups = {"TC-35474","US-2079","BUG-972","CLOSED"}, priority = 55)
    ...
    public void testViewTranscriptPage() throws IOException{
	   try{
           ...
           xpath = Common.transcriptPageTitleXpath(driver);
           helper.assertWebElementExist(driver, new Exception().getStackTrace()[0], xpath);
           actual = helper.getText(driver, xpath);          
           if (actual.contains(":")) { expected = Common.transcriptPageTitleText[0]; } else { expected = Common.transcriptPageTitleText[1]; };
...
//         helper.getUrlWaitUntil(driver, 15, url);
	 ...
	 */
	@Test(groups = {"TC-36419","US-3966","BUG-972","CLOSED"}, priority = 59)
