...
public class BrandPage {
	 ...
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 35131 3229 972</p> 
	 */
	@Test(groups = {"TC-35131","US-3229","BUG-972","CLOSED"}, priority = 1)
	 ...
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 35131 35153 3229 972</p>
	 */
	@Test(groups = {"TC-35131","TC-35153","US-3229","BUG-972","CLOSED"}, priority = 2)
	 ...
	 */
	@Test(groups = {"TC-35131","TC-35153","US-2958","US-3229","BUG-35502","BUG-524","BUG-528","BUG-529","BUG-823","BUG-852","BUG-972","CLOSED"}, priority = 3)
...
//            helper.createCustomBrand(driver, text, true, true, robot, fingerprint);
	 ...
	 * <p>Modified Version: </p>
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 35153 35131 3229 972</p>
	 */
	@Test(groups = {"TC-35153","TC-35131","US-3229","BUG-972","CLOSED"}, priority = 4)
	 ...
	 * <p>Test Cases: 35153 35131 3229 972</p>
	 */
	@Test(groups = {"TC-35153","TC-35131","US-3229","BUG-972","CLOSED"}, priority = 5)
	 ...
	 * <p>Modified Version: </p>
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 34558 3461 972</p>
	 */
	@Test(groups = {"TC-34558","US-3461","BUG-972","CLOSED"}, priority = 23)
    ...
    public void testBrandPageHeroBoxImageUploadLessThenMinDimensionsNotAllowed() throws IOException, IllegalArgumentException, MalformedURLException {
	       try{	    	   
	           ...
	           // CREATE CONTENT WITH BOTH AGES SELECTED:
	           helper.createCustomBrand(driver, title, description, true, true, false, false, new RuntimeException().getStackTrace()[0], "bubble.jpg", image, "", "");
	 ...
	 * <p>Modified Version: </p>
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 35154 3311 35220 3188 972</p>
	 */
	@Test(groups = {"TC-35154","US-3311","TC-35220","US-3188","BUG-972","CLOSED"}, priority = 27)
    public void  testBrandPageHeroBoxImageUploadAlternativeTextNotExist() throws IOException, IllegalArgumentException, MalformedURLException {
	       try{
	           ...
	           // CREATE CONTENT WITH BOTH AGES SELECTED:
	           helper.createCustomBrand(driver, title, description, true, true, true, true, true, new Exception().getStackTrace()[0],
	 ...
	 */
	@Test(groups = {"TC-35220","US-3188","BUG-707","BUG-972","CLOSED"}, priority = 28)
    public void testBrandPageSmallTileImageIsMandatory() throws IOException, IllegalArgumentException, MalformedURLException {
	       try{
	           ...
	           // CREATE CONTENT WITH BOTH AGES SELECTED:	           
	           helper.createCustomBrand(driver, title, description, true, true, false, true, false, new RuntimeException().getStackTrace()[0], "bubble.jpg", "hero.jpg", "", "", "");
	 ...
	 * <p>Modified Version: V2</p>
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 35220 3188 3996 4452 972</p>
	 */
	@Test(groups = {"TC-35220","US-3188","US-3996","US-4452","BUG-972","CLOSED"}, priority = 29)
    public void testBrandPageSmallTileImageUploadLargerThenMaxSizeNotAllowed() throws IOException, IllegalArgumentException, MalformedURLException {
	       try{
	           ...
	           // CREATE CONTENT WITH BOTH AGES SELECTED:	           
	           helper.createCustomBrand(driver, title, description, true, true, false, false, new RuntimeException().getStackTrace()[0], "bubble.jpg", "hero.jpg", image, "");
	 ...
	 * <p>Modified Version: </p>
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 35220 3188 3996 972</p>
	 */
	@Test(groups = {"TC-35220","US-3188","US-3996","BUG-972","CLOSED"}, priority = 30)
	 ...
	 */
	@Test(groups = {"TC-35220","US-3188","US-3996","BUG-699","BUG-972","CLOSED"}, enabled = true, priority = 31)
	 ...
	 * <p>Test Cases: 35220 3188 3996 4452 972</p>
	 */
	@Test(groups = {"TC-35220","US-3188","US-3996","US-4452","BUG-972","CLOSED"}, priority = 32)
    public void testBrandPageLargeTileImageUploadLargerThenMaxSizeNotAllowed() throws IOException, IllegalArgumentException, MalformedURLException {
	       try{
	           ...
	           // CREATE CONTENT WITH BOTH AGES SELECTED:	           
	           helper.createCustomBrand(driver, title, description, true, true, false, false, new RuntimeException().getStackTrace()[0], "bubble.jpg", "hero.jpg", "small.jpg", image);
	 ...
	 * <p>Test Cases: 35220 3188 3996 972</p>
	 */
	@Test(groups = {"TC-35220","US-3188","US-3996","BUG-972","CLOSED"}, priority = 33)
	 ...
	 */
	@Test(groups = {"TC-35220","US-3188","US-3996","BUG-708","BUG-972","CLOSED"}, enabled = true, priority = 34)
	 ...
	 * <p>Modified Version: </p>
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 35158 3610 972</p>
	 */
	@Test(groups = {"TC-35158","US-3610","BUG-972","CLOSED"}, priority = 35)
	 ...
	 * <p>Modified Version: </p>
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 35160 3610 972</p>
	 */
	@Test(groups = {"TC-35160","US-3610","BUG-972","CLOSED"}, priority = 36)
	 ...
	 * <p>Modified Version: </p>
	 * <p>Xpath: 1</p>
	 * <p>Test Cases: 35161 3610 972</p>
	 */
	@Test(groups = {"TC-35161","US-3610","BUG-972","CLOSED"}, priority = 37)
